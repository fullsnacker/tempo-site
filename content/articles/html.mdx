---
date: 30 may 2022
title: ¿Qué es HTML, cómo se usa y con que se come?
description: HTML significa Hyper Text Markup Language (O lenguaje de marcado de hipertexto).
readingTime: 3
highlight: true
topic: ''
type: ''
url: 'https://dev.to/fullsnacker/que-es-html-como-se-usa-y-con-que-se-come-4cam'
---
