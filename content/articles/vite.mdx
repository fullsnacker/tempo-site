---
date: 21 sep 2022
title: Crea una app en react en 5 minutos
description: Vamos a crear una app en React y levantarla en cuestión de solo unos minutos con Vite.js.
readingTime: 4
highlight: true
topic: ''
type: ''
url: 'https://dev.to/fullsnacker/crea-una-app-en-react-en-5-minutos-ick'
---
